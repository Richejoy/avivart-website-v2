    ...
    <div class="row">
      <div class="col-lg-4 mb-3">
        <div class="card h-100">
          <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fHNvZnR3YXJlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="card-img-top img-200x200" alt="Image">
          <div class="card-body bg-light">
            <h5 class="card-title font-weight-bold">Développement d'applications</h5>
            <p>
              Cette formation vous fera acquérir les technologies nécessaires pour concevoir un site ou une application web et une application mobile.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-3">
        <div class="card h-100">
          <img src="{{ asset('public/img/trainings/database.png') }}" class="card-img-top img-200x200" alt="Image">
          <div class="card-body bg-light">
      ...
      <div class="col-lg-4 mb-3">
        <div class="card h-100">
          <img src="{{ asset('public/img/trainings/reseau.jpg') }}" class="card-img-top img-200x200" alt="Image">
          <div class="card-body bg-light">
...
<section class="bg-light py-5">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        ...
        <p class="text-justify">
          AVIV’ART œuvre très efficacement dans les domaines qui les passionnent pour la grande satisfaction des clients.
        </p>
      </div>
    </div>
    ...
    <div class="row py-3">
      ...
      <div class="col-lg-3 col-sm-6 text-center">
        <p>
          <img src="{{ asset('public/img/partners/nbfconsulting.png') }}" alt="NBF CONSULTING" class="img-150x150 w-100">
        </p>
      </div>
