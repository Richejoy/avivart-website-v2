@extends('layouts.store', ['title' => $productType->name])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h4 class="font-weight-bold text-light">{{ $productType->name }} | Produits liés ({{ $productType->products->count() }})</h4>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="card-body">
                                ...
                                <ul type="circle" class="list-unstyled simple-load-more">
                                    ...
                                    <li class=""><a class="text-muted"
                                                href="{{ route('productType.show', ['productType' => $prdType]) }}">{{ $prdType->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                                @else
