	            ...
	            <div class="card shadow-sm">
	            	...
	            	<div class="card-body">
				        ...
				        <ol class="list-unstyled">
				        	...
				        	<li><a href="{{ route('productRay.show', ['productRay' => $productRay]) }}">{{ $productRay->name }} <i class="fa fa-chevron-down float-right"></i></a></li>

				        	@if($productRay->productCategories->count())
					        <ul class="">
								@foreach($productRay->productCategories as $productCategory)
					        	<li><a class="text-muted" href="{{ route('productCategory.show', ['productCategory' => $productCategory]) }}">{{ $productCategory->name }}</a></li>
					        	@endforeach
					        </ul>
					        @endif
	            	...
	            	<div class="card-footer text-right"><a href="{{ route('productRay.index') }}" class="text-danger">Tout afficher</a></div>
	            </div>
	            ...
	            <div class="card mt-3 shadow-sm">
	            	...
	            	<div class="card-body">
				        ...
				        <ol class="list-unstyled">
				        	...
				        	<li><a class="text-muted" href="{{ route('productType.show', ['productType' => $productType]) }}">{{ $productType->name }}</a></li>
				        	@endforeach
				        </ol>
				        @else
	            	...
	            	<div class="card-footer text-right"><a href="{{ route('productType.index') }}" class="text-danger">Tout afficher</a></div>
	            </div>

			</aside>

			<div class="col-lg-9">
				<div style="padding: 13px" class="mt-xs-3 mb-3 bg-success text-white font-weight-bold shadow-sm rounded">
					<i class="fa fa-bell fa-pulse"></i> Commandez vos aliments en ligne, payez sans frais et faites vous livrer
				</div>
