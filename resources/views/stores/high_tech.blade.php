				    ...
				    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
				      <div class="card-body">
				        ...
				        <ul type="circle" class="list-unstyled">
				        	...
				        	<li><a class="{{ $productCategory->getSelected(Request::query('product_category_id')) }}" href="{{ route('store.high_tech', ['product_category_id' => $productCategory->id]) }}">{{ $productCategory->name }}</a></li>
				        	@endforeach
				        </ul>
				        @else
