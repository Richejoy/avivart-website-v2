            ...
            <aside class="col-lg-3 pb-3">
                ...
                <div class="accordion" id="accordion1">
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul type="circle" class="list-unstyled simple-load-more">
                                    ...
                                    <li><a class="{{ $productCategory->getSelected(Request::query('product_category_id')) }}"
                                            href="{{ route('store.high_tech', ['product_category_id' => $productCategory->id]) }}">{{ $productCategory->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                @else
                        ...
                        <div class="card-footer p-2 text-right"><a href="{{ route('productCategory.index', ['product_ray_id' => 4]) }}"
