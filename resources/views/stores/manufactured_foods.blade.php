@extends('layouts.store', ['title' => 'Aliments Manufacturés'])
            ...
            <aside class="col-lg-3 pb-3">
                ...
                <div class="accordion" id="accordion1">
                    <div class="card">
                        <div class="card-header p-0 bg-white font-weight-bold" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn btn-link btn-block text-left text-decoration-none text-dark"
                                    ...
                                    <i class="fa fa-plus"></i> Aliments Manufacturés
                                </button>
                            </h2>
                        </div>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <ul type="circle" class="list-unstyled simple-load-more">
                                    <li><a class="text-danger" href="{{ route('store.manufactured_foods') }}">Tout</a>
                                    </li>

                                    @foreach($productCategories as $productCategory)
                                    <li><a class="{{ $productCategory->getSelected(Request::query('product_category_id')) }}"
                                            href="{{ route('store.manufactured_foods', ['product_category_id' => $productCategory->id]) }}">{{ $productCategory->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                @else
                        ...
                        <div class="card-footer p-2 text-right"><a href="{{ route('productCategory.index', ['product_ray_id' => 2]) }}"
