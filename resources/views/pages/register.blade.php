    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 d-none d-sm-block d-flex align-self-center">
                <img src="https://cdn.pixabay.com/photo/2018/11/29/21/51/social-media-3846597__340.png" alt="" class="w-100">
            </div>
            ...
            <h6 class="text-center">Inscrivez-vous gratuitement en quelques secondes et passez vos commandes de produits en toute liberté.</h6>
            ...
            <div class="form-group text-center">
                ...
                <label for="tou" class="text-dark">J'ai lu et j'accepte les {{ link_to_route('page.conditions', "conditions", null, ['class' => 'text-danger']) }} et {{ link_to_route('page.terms', "termes", null, ['class' => 'text-danger']) }} du site</label>
            </div>
