            ...
            <div class="container-fluid py-3">
                <div class="row">
                    <div class="col-lg-8 text-info text-lg-center">
                        ...
                        est fait par <a class="text-primary" href="#" target="_blank">AVIV'ART DESIGN</a>
                    </div>
                    <div class="col-lg-4 text-info text-lg-center">
                        Fait avec <i class="fa fa-heart text-danger"></i> par <a class="text-primary" href="#" target="_blank">AVIV'ART-DEV</a>
                    </div>
                </div>
            </div>
        </section>
