@extends('layouts.cosmetic', ['title' => 'Comment ça marche ?'])
    ...
    <div class="container-fluid">
        ...
        <div class="row py-3">
            <div class="col-lg-4 text-center">
                <p><span class="badge badge-warning py-2 px-3">1</span></p>
            ...
            <div class="col-lg-4 text-center">
                <p><span class="badge badge-warning py-2 px-3">2</span></p>
            ...
            <div class="col-lg-4 text-center">
                <p><span class="badge badge-warning py-2 px-3">3</span></p>
...
<section class="bg-info py-5">
    <div class="container">
        <div class="row py-3">
            <div class="col-lg-12 text-center">
                <h2 class="font-weight-bold text-warning">Vos Avantages</h2>
            </div>
        </div>
