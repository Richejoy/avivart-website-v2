@extends('layouts.ad', ['title' => 'Autres Annonces'])
            ...
            <aside class="col-lg-3 pb-3">
                ...
                <div class="accordion" id="accordion1">
                    <div class="card">
                        <div class="card-header p-0 bg-white font-weight-bold" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn btn-link btn-block text-left text-decoration-none text-dark"
                                    ...
                                    <i class="fa fa-plus"></i> Autres Annonces
                                </button>
                            </h2>
                        </div>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <ul type="circle" class="list-unstyled simple-load-more">
                                    <li><a class="text-danger" href="{{ route('ad.other_ads') }}">Tout</a></li>

                                    @foreach($adCategories as $adCategory)
                                    <li><a class="{{ $adCategory->getSelected(Request::query('ad_category_id')) }}"
                                            href="{{ route('ad.other_ads', ['ad_category_id' => $adCategory->id]) }}">{{ $adCategory->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                @else
                        ...
                        <div class="card-footer p-2 text-right"><a href="{{ route('adCategory.index', ['ad_ray_id' => 5]) }}"
