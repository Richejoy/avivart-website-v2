	...
	<div class="col-lg-12">
        ...
        <div>
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#identity" aria-controls="identity" role="tab" data-toggle="tab">Identité</a></li>
                ...
                <li role="presentation"><a href="#phone" aria-controls="phone" role="tab" data-toggle="tab">Téléphone</a></li>

                <li role="presentation"><a href="#password" aria-controls="password" role="tab" data-toggle="tab">Mot de passe</a></li>

                <li role="presentation"><a href="#avatar" aria-controls="avatar" role="tab" data-toggle="tab">Photo de profil</a></li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="email" role="tabpanel">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Veuillez mettre une adresse email valide. Elle ne sera pas utiliser à d'autres fins</small>
                </div>
                <div class="form-group">
              ...
              <div class="tab-pane" id="phone" role="tabpanel">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Veuillez mettre un numero valide sans l'indicatif. IL ne sera pas utiliser à d'autres fins</small>
                </div>
                <div class="form-group">
              ...
              <div class="tab-pane" id="avatar" role="tabpanel">
                <p>
                    <img src="{{ Auth::user()->image->link }}" id="preview-upload" width="100" height="100" alt="Image" class="circle">
                </p>
