...
<head>
    ...
    @include('meta::manager', [
        'title' => fullPageTitle($title, 'Immobilier'),
    ])
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/immovable.css') }}">
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('js/immovable.js') }}"></script>
