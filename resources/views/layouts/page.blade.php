...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
		<div class="container-fluid">
	  		<a  class="navbar-brand p-0" href="{{ route('page.index') }}"><img src="{{ asset('public/img/logo_black.png') }}" alt="{{ config('app.name') }}" class="logo-xs"></a>
				...
				<div class="row">
					...
					<div class="col-lg-4">
	    				...
	    				<ul class="list-unstyled d-flex flex-row justify-content-around align-items-center my-2">
							<li class="">
								<a href="" class="text-white text-decoration-none social-icon facebook"><i class="fa fa-facebook"></i></a>
							</li>
							<li class="pl-3 pr-3">
								<a href="" class="text-white text-decoration-none social-icon twitter"><i class="fa fa-twitter"></i></a>
							</li>
							<li class="">
								<a href="" class="text-white text-decoration-none social-icon instagram"><i class="fa fa-instagram"></i></a>
							</li>
							<li class="">
								<a href="" class="text-white text-decoration-none social-icon whatsapp"><i class="fa fa-whatsapp"></i></a>
							</li>
							<li class="">
								<a href="" class="text-white text-decoration-none social-icon youtube"><i class="fa fa-youtube"></i></a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="container-fluid py-3">
				<div class="row">
					<div class="col-lg-8 text-muted text-lg-center">
						Copyright &copy; {{ date('Y') }} Tous droits réservés, par {{ config('app.name') }} | Ce design est fait avec <i class="fa fa-heart text-danger"></i> par <a class="text-success" href="#" target="_blank">AVIV'ART DESIGN</a></a>
					</div>
