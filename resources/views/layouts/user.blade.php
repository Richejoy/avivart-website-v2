...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ asset('public/plugins/adminlte2.4.18/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('public/plugins/adminlte2.4.18/bower_components/font-awesome/css/font-awesome.min.css') }}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('public/plugins/adminlte2.4.18/bower_components/Ionicons/css/ionicons.min.css') }}">
  <!-- Theme style -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="{{ route('user.index') }}" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ Auth::user()->image->link }}" class="user-image" alt="User Image" width="160" height="160">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  ...
                  <div class="col-xs-4 text-center">
                    <a href="{{ route('user.favorite_products') }}"><i class="fa fa-star"></i></a>
                  </div>
                  <div class="col-xs-4 text-center">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('user.show', array('user' => Auth::user())) }}" class="btn btn-default btn-flat">Profil</a>
                </div>
                <div class="pull-right">
                  <a href="{{ route('page.logout') }}" class="btn btn-default btn-flat">Déconnexion</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="{{ route('user.show', array('user' => Auth::user())) }}"><i class="fa fa-calendar text-success"></i> {{ Auth::user()->last_login }}</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('user.show', array('user' => Auth::user())) }}"><i class="fa fa-user"></i> Profil</a></li>
            <li><a href="{{ route('user.edit', array('user' => Auth::user())) }}"><i class="fa fa-pencil"></i> Edition</a></li>
            <li><a href="{{ route('page.logout') }}"><i class="fa fa-lock"></i> Déconnexion</a></li>
          </ul>
        </li>

        <li><a href="{{ route('settings.index') }}"><i class="fa fa-cog"></i> <span>Parametres</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('public/plugins/adminlte2.4.18/bower_components/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- SlimScroll -->
<script src="{{ asset('public/plugins/adminlte2.4.18/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
<!-- FastClick -->
